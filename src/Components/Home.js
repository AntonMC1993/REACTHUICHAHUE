      ...
      <div>
        <ul className="fotosProductos">
          <li id="cervezas">
            ...
            <img src={cerveza4} alt="cerveza1" width="400px" />
            <img src={cerveza5} alt="cerveza2" width="400px" />
            <img src={cerveza6} alt="cerveza3" width="400px" />
          </li>
        </ul>
      </div>
      <br></br>
      ...
      <div>
        <ul className="fotospacks">
          <li id="packs">
            ...
            <img src={pack3} alt="cerveza2" width="400px" />
          </li>
        </ul>
      </div>
            <br></br><br></br>
